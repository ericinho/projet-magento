...
class Learning_Domaine_Block_Adminhtml_Domaine_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    public function __construct()
    {
        ...
        $this->setId('learning_domaine_domaine_grid');
    ...
    {
        $collection = Mage::getModel('learning_domaine/domaine')->getCollection();
    ...
    protected function _prepareMassaction()
    {
        ...
        $this->getMassactionBlock()->setFormFieldName('domaine');
